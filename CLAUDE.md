# @fgd/ui — Agent Context

This is the `@fgd/ui` component library. It exports a set of React components built on Radix UI primitives, styled with Tailwind v4 design tokens.
